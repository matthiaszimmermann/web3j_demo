...
![Create the Java contract wrapper](screenshots/screenshot_eclipse_ide_compilecontract.png)
...
![Run the ContractDemo](screenshots/screenshot_eclipse_ide_contractdemo.png)
